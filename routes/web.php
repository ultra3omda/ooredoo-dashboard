...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('api')->group(function () {
        ...
        Route::get('/dashboard/operators', [DataController::class, 'getAvailableOperators'])->name('api.dashboard.operators');
        Route::get('/dashboard/partners', [DataController::class, 'getPartnersList'])->name('api.dashboard.partners');
        Route::get('/dashboard/kpis', [DataController::class, 'getKpis'])->name('api.dashboard.kpis');
        Route::get('/dashboard/merchants', [DataController::class, 'getMerchants'])->name('api.dashboard.merchants');
        Route::get('/dashboard/transactions', [DataController::class, 'getTransactions'])->name('api.dashboard.transactions');
        Route::get('/dashboard/subscriptions', [DataController::class, 'getSubscriptions'])->name('api.dashboard.subscriptions');

        Route::get('/dashboard/split/kpis', [DataControllerOptimized::class, 'getKpisSplit'])->name('api.dashboard.split.kpis');
        Route::get('/dashboard/split/merchants', [DataControllerOptimized::class, 'getMerchantsSplit'])->name('api.dashboard.split.merchants');
        Route::get('/dashboard/split/transactions', [DataControllerOptimized::class, 'getTransactionsSplit'])->name('api.dashboard.split.transactions');
        Route::get('/dashboard/split/subscriptions', [DataControllerOptimized::class, 'getSubscriptionsSplit'])->name('api.dashboard.split.subscriptions');
        Route::get('/dashboard/split/ooredoo', [DataControllerOptimized::class, 'getOoredooStatsSplit'])->name('api.dashboard.split.ooredoo');
    });
    ...
    // Dashboard Sub-Stores (accès restreint rôle sub-stores)
    ...
    Route::middleware(['auth', 'dashboard.access:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware('check.dashboard:eklektik-config')->group(function () {
            ...
            Route::prefix('eklektik')->name('eklektik.')->group(function () {
                Route::get('/dashboard', fn () => redirect()->route('sub-stores.dashboard'))->name('legacy-dashboard');
