...
class MLClientFeature extends Model
{
    ...
    protected $fillable = [
        ...
        'timwe_total_successes',
        'timwe_avg_revenue_per_success',
        'timwe_no_balance_rate',
        'timwe_not_delivered_rate',
        'timwe_has_activity',
        'eklektik_success_rate',
        'eklektik_total_attempts',
        'eklektik_total_subscriptions',
        'eklektik_avg_daily_successes',
        'eklektik_daily_consistency',
        'eklektik_has_activity',
        'ooredoo_success_rate',
        'ooredoo_total_attempts',
        'ooredoo_total_subscriptions',
        'ooredoo_avg_monthly_successes',
        ...
        'eklectic_90d_sum',
        'eklectic_90d_avg',
        'club_privilege_90d_count',
        'club_privilege_90d_sum',
        'club_privilege_90d_avg',
    ];
    ...
    protected $casts = [
        ...
        // Features 90 jours
        'total_90d_count' => 'integer',
        'total_90d_sum' => 'decimal:3',
        'total_90d_avg' => 'decimal:3',
        'last_tx_90d_at' => 'datetime',
        'timwe_90d_count' => 'integer',
        'timwe_90d_sum' => 'decimal:3',
        'timwe_90d_avg' => 'decimal:3',
        'orange_90d_count' => 'integer',
        'orange_90d_sum' => 'decimal:3',
        'orange_90d_avg' => 'decimal:3',
        'taraji_90d_count' => 'integer',
        'taraji_90d_sum' => 'decimal:3',
        'taraji_90d_avg' => 'decimal:3',
        'tt_90d_count' => 'integer',
        'tt_90d_sum' => 'decimal:3',
        'tt_90d_avg' => 'decimal:3',
        'ooredoo_90d_count' => 'integer',
        'ooredoo_90d_sum' => 'decimal:3',
        'ooredoo_90d_avg' => 'decimal:3',
        'dgv_90d_count' => 'integer',
        'dgv_90d_sum' => 'decimal:3',
        'dgv_90d_avg' => 'decimal:3',
        'eklektik_90d_count' => 'integer',
        'eklektik_90d_sum' => 'decimal:3',
        'eklektik_90d_avg' => 'decimal:3',
        'eklectic_90d_count' => 'integer',
        'eklectic_90d_sum' => 'decimal:3',
        'eklectic_90d_avg' => 'decimal:3',
        'club_privilege_90d_count' => 'integer',
        'club_privilege_90d_sum' => 'decimal:3',
        'club_privilege_90d_avg' => 'decimal:3',
    ];
